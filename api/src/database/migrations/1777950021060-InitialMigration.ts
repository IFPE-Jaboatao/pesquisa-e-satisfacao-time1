...
export class InitialMigration1777950021060 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "profiles" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying, CONSTRAINT "PK_8e520eb4da7dc01d0e190447c8e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."classes_active_enum" AS ENUM('ACTIVE', 'INACTIVE')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."courses_active_enum" AS ENUM('ACTIVE', 'INACTIVE')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "user_profiles" ("user_id" uuid NOT NULL, "profile_id" uuid NOT NULL, CONSTRAINT "PK_2f0bbd2659d46a1a4a86f6a5eab" PRIMARY KEY ("user_id", "profile_id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_6ca9503d77ae39b4b5a6cc3ba8" ON "user_profiles" ("user_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_acac04b2506d607942b566710e" ON "user_profiles" ("profile_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "courses" ADD CONSTRAINT "FK_ef7bdde8beabe797415726e84c9" FOREIGN KEY ("campus_id") REFERENCES "campuses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "services" ADD CONSTRAINT "FK_bdee1f7825a30fcdf59ed166fb9" FOREIGN KEY ("campus_id") REFERENCES "campuses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user_profiles" ADD CONSTRAINT "FK_acac04b2506d607942b566710e1" FOREIGN KEY ("profile_id") REFERENCES "profiles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "user_profiles" DROP CONSTRAINT "FK_acac04b2506d607942b566710e1"`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_profiles" DROP CONSTRAINT "FK_6ca9503d77ae39b4b5a6cc3ba88"`,
    );
    await queryRunner.query(
      `ALTER TABLE "services" DROP CONSTRAINT "FK_bdee1f7825a30fcdf59ed166fb9"`,
    );
    await queryRunner.query(
      `ALTER TABLE "courses" DROP CONSTRAINT "FK_ef7bdde8beabe797415726e84c9"`,
    );
    await queryRunner.query(
      `ALTER TABLE "classes" DROP CONSTRAINT "FK_bd4c6c725acd427f07264770ceb"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_acac04b2506d607942b566710e"`,
    );
    await queryRunner.query(
